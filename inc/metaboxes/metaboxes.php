	...
	class PyreThemeFrameworkMetaboxes {
		...
		function admin_script_loader() {
			...
			if ( is_admin() && ( in_array( $pagenow, array( 'post-new.php', 'post.php' ) ) ) ) {
				...
				$template_dir_url = Georgtheme::$template_dir_url;
				$version = Georgtheme::$theme_object->get( 'Version' );

				wp_enqueue_script(
					'jquery.biscuit',
					$template_dir_url . '/inc/assets/js/vendor/jquery.biscuit.js',
					array( 'jquery' ),
					$version
				);
				...
				wp_enqueue_style(
					'georg_tiptip_css',
					$template_dir_url . '/inc/assets/css/vendor/tipTip/tipTip.css',
					array(),
					$version 
				);
        wp_enqueue_script(
        	'georg_jquery_tiptip', 
        	$template_dir_url . '/inc/assets/js/vendor/tipTip/jquery.tipTip.min.js', 
        	array( 'jquery' ), 
        	$version, 
        	true 
        );
				...
				wp_register_script(
					'avada_upload',
					$template_dir_url . '/inc/assets/js/vendor/upload.js',
					array( 'jquery' ),
					$version
				);
				...
				wp_enqueue_style(
					'select2-css',
					$template_dir_url . '/inc/assets/css/vendor/select2.css',
					array(),
					$version,
					'all'
				);
				...
				wp_enqueue_script(
					...
					$template_dir_url . '/inc/assets/js/vendor/select2.min.js',
					array( 'jquery' ),
					$version
				);
				...
				wp_enqueue_style(
					...
					$template_dir_url . '/inc/assets/css/vendor/fusionredux.jquery.nouislider.css',
					array(),
					$version,
					'all'
				);
				...
				wp_enqueue_script(
					...
					$template_dir_url . '/inc/assets/js/vendor/jquery.nouislider.min.js',
					array( 'jquery' ),
					$version,
					true
				);
				wp_enqueue_script(
					'wnumb-js',
					$template_dir_url . '/inc/assets/js/vendor/wNumb.js',
					array( 'jquery' ),
					$version,
					true
				);
				...
				wp_enqueue_script(
					...
					$template_dir_url . '/inc/assets/js/vendor/wp-color-picker-alpha.js',
					array( 'wp-color-picker' )
				);

				// General JS for fields.
				wp_enqueue_script(
					'avada-fusion-options', $template_dir_url . '/inc/assets/js/vendor/avada-fusion-options.js',
					array( 'jquery' ),
					$version
				);
				...
				wp_enqueue_style(
					'avada-admin-css',
					$template_dir_url . '/inc/assets/css/admin.css',
					array()
				);

				wp_enqueue_script(
					'wp-avada-admin-js',
					$template_dir_url . '/inc/assets/js/admin.js',
					array(),
					true
				);
		...
		public function radio_buttonset( $id, $label, $options, $desc = '', $dependency = array() ) {
			...
			<div class="pyre_metabox_field">
				...
				<div class="pyre_field avada-buttonset">
					<div class="georgtheme-form-radio-button-set ui-buttonset">
